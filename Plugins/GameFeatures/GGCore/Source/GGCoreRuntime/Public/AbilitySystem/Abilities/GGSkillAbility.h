...
#include "GGSkillAbility.generated.h"

/**
 * 
 */
UCLASS()
class GGCORERUNTIME_API UGGSkillAbility : public ULyraGameplayAbility
{
	GENERATED_BODY()
...
protected:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GG|Skill|Effects")
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "GG|Skill|Effects")
